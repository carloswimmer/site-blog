...
export const PostCard = ({
  ...
  return (
    <Link
      href={`/blog/${slug}`}
      className="w-full max-w-2xl rounded-2xl border-[1px] border-gray-400 bg-gray-600 overflow-hidden transition-all duration-300 hover:border-[1px] hover:border-blue-300"
    >
      {/* Post Content */}
      <div className="p-2 rounded-md overflow-hidden">
        {/* Image Container */}
        <div className="relative">
          <div className="absolute top-0 right-0 px-3 pb-2 bg-gray-600 backdrop-blur-sm rounded-bl-xl">
